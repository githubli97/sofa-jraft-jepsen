...
git clone https://github.com/githubli97/sofa-jraft-jepsen.git
cd sofa-jraft-jepsen/jepsen.atomic
cp -f /usr/local/nodes ./nodes
cp -f /usr/local/control.clj ./control.clj